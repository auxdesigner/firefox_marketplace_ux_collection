...
gv_vAlignTable['u15'] = 'center';document.getElementById('u12_img').tabIndex = 0;
...
gv_vAlignTable['u1'] = 'center';gv_vAlignTable['u4'] = 'center';document.getElementById('u5_img').tabIndex = 0;
...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('collections.html');
